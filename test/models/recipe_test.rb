...
class RecipeTest < ActiveSupport::TestCase
  ...
  def setup
    ...
    @recipe = @chef.recipes.build(name: "Chicken Farm", summary: "This is the best chicken farm forever", 
              description: "Head oil, add onion, add tomato source, cook for 20 minutes")
  end
